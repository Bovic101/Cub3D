...
/*   Updated: 2024/12/29 07:15:49 by vodebunm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx_data.player->x_cordinate=(mlx_data.s_map_data->player_block_x + 0.5) * BLOCK_SIZE;
	mlx_data.player->y_cordinate=(mlx_data.s_map_data->player_block_y + 0.5) * BLOCK_SIZE;
